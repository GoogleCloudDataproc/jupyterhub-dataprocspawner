...
def get_custom_cluster_html_form(autoscaling_policies, node_types):
  ...
  html_master_disk_type += '''<option value="pd-standard">Standard Persistent Disk</option>
      <option value="pd-ssd">SSD Persistent Disk</option>'''
  html_master_disk_type += "</select></div>"

  html_master_disk_size = """<div class="form-group">
      <label for="master_disk_size">Master disk size</label>
      <input name="master_disk_size" class="form-control" placeholder="default"
            value=""></input>
  </div>"""
  ...
  html_worker_disk_type += '''<option value="pd-standard">Standard Persistent Disk</option>
      <option value="pd-ssd">SSD Persistent Disk</option>'''
  html_worker_disk_type += "</select></div>"

  html_worker_disk_size = """<div class="form-group">
      <label for="worker_disk_size">Worker disk size</label>
      <input name="worker_disk_size" class="form-control" placeholder="default"
            value=""></input>
  </div>"""
