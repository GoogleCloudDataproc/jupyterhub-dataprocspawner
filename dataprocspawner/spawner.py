...
################################################################################
  ...
  def _build_cluster_config(self, cluster_data=None):
    ...
    exclusive_property = 'dataproc:dataproc.exclusive.user'
    ...
    if self.user_options:
      ...
      exclusive = self.user_options.get('exclusive')
      ...
      if exclusive == 'on':
        (cluster_data['config']['software_config']['properties']
                     [exclusive_property]) = self.user.name
    ...
    if (self.force_single_user or
        exclusive_property in cluster_data['config']['software_config']['properties']):
      (cluster_data['config']['software_config']['properties']
                   [exclusive_property]) = self.user.name
